<?php import::view(TEMA.'header'); ?>
	...
	<div class="home">
		...
		<div class="home_content d-flex flex-column align-items-center justify-content-center">
			<h2 class="home_title"><?php echo category($cat_id)->name; ?></h2>
		</div>
	</div>
					...
					<div class="shop_sidebar">
						<div class="sidebar_section">
							...
							<ul class="sidebar_categories">
								<?php foreach (menu($cat_id) as $key): ?>
									<li><a href="/category/<?php echo $key->id.'-'.$key->seo; ?>"><?php echo $key->name ?></a></li>
								<?php endforeach ?>
						...
						<div class="sidebar_section">
							...
							<ul class="brands_list">
								<?php foreach (brand() as $key ): ?>
									<li class="brand"><a href="#"><?php echo $key->brand; ?></a></li>
								<?php endforeach ?>
				...
				<div class="col-lg-9">
					...
					<div class="shop_content">
						<div class="shop_bar clearfix">
							<div class="shop_product_count">Toplam <span><?php echo count(category_list_products($cat_id)); ?></span> ürün bulundu</div>
						...
						<div class="product_grid">
							...
							<?php foreach (category_list_products($cat_id) as $key ): ?>
							<!-- Product Item -->
							<div class="product_item is_new">
								...
								<div class="product_image d-flex flex-column align-items-center justify-content-center" style="width:118px; height: 81px;">
									<img src="/<?php echo mainimage($key->id); ?>" alt=""></div>
								<div class="product_content">
									<div class="product_price"><?php echo $key->price ?> TL</div>
									<div class="product_name"><div><a href="/product_detail/<?php echo $key->id.'-'.$key->title_seo ?>" tabindex="0"><?php echo $key->title ?></a></div></div>
								</div>
