...
<div id="user-nav" class="navbar navbar-inverse">
  <ul class="nav">
    <li  class="dropdown" id="profile-messages" ><a title="" href="#" data-toggle="dropdown" data-target="#profile-messages" class="dropdown-toggle"><i class="icon icon-user"></i>  <span class="text">{[ echo Session::select('name'); ]}</span><b class="caret"></b></a>
      <ul class="dropdown-menu">
        <li><a href="#"><i class="icon-user"></i> Mağaza Listesi</a></li>
        <li class="divider"></li>
        <li><a href="#"><i class="icon-check"></i> Siparişler</a></li>
        <li class="divider"></li>
