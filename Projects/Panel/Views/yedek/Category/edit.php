   	...
   	<div class="widget-content nopadding">
           ...
           <div class="control-group">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                  <img src="/upload/products_category/<?php echo $edit->img ?>" alt="" width="100">
          	...
          	<div class="control-group">
                ...
                <div class="controls">
		            <input type="text" class="span11" name="category_name" value="<?php echo $edit->name; ?>">
		        </div>
              <div class="control-group">
                <label class="control-label">Kategori DURUMU:</label>
                <div class="controls">
                <select name="status" id="">
                  <option value="1" <?php echo $edit->status == 1?'selected':'0;' ?>>Aktif</option>
                  <option value="0" <?php echo $edit->status == 0?'selected':'0;' ?>>Pasif</option>
                </select>
            </div>
		    </div>
