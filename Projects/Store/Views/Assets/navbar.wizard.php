  ...
  <ul class="nav">
    <li  class="dropdown" id="profile-messages" >
      <a title="" href="#" data-toggle="dropdown" data-target="#profile-messages" class="dropdown-toggle">
        <i class="icon icon-user"></i>  <span class="text">{{Session::select('STORENAME')}}</span><b class="caret"></b></a>
    ...
    <li class=""><a title="" href="/store/login/cikis"><i class="icon icon-share-alt"></i> <span class="text">Çıkış</span></a></li>
      <li><a href="{{URL::base()}}" target="_blank"><i class="icon-home"></i> Site</a></li>
  </ul>
</div>
